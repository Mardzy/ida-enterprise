 ...
 */
function isBuilding () {
  return _.startsWith(process.env.npm_lifecycle_event, "build");
}

/**
 * Tell whether we build production or not
 * @return {boolean}
 */
function isProduction () {
  return isBuilding() && _.endsWith(process.env.npm_lifecycle_event, "production");
}
